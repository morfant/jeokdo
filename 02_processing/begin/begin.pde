...
<프로세싱에서 한글을 사용할 수 있도록 설정하기>

설정 -> Enable complex text input 을 체크(활성화) -> 프로세싱 재실행
...
<Basic>
0. 실행과 중지의 연습 : 마우스로 키보드로

1. 줄을 끝낼때는 ';' (세미콜론)을 잊지 말아요 - 이게 없으면 컴퓨터는 줄이 끝났다는 것을 알 방법이 없음

2. 열린 괄호는 반드시 닫혀야 한다.
    괄호_1 안에 괄호_2 안의 괄호_3 ... 괄호_3 닫고, 괄호_2 닫고, 괄호_1 닫기.

3. 대소문자를 구분해서 사용한다. ex) size 와 Size는 명확히 다르다.
